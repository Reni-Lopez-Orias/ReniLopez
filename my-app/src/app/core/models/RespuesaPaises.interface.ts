// To parse this data:
//
//   import { Convert, RespuestaPaises } from "./file";
//
//   const respuestaPaises = Convert.toRespuestaPaises(json);
//
...
export class Convert {
    public static toRespuestaPaises(json: string): RespuestaPaises {
        return cast(JSON.parse(json), r("RespuestaPaises"));
    }

    public static respuestaPaisesToJson(value: RespuestaPaises): string {
        return JSON.stringify(uncast(value, r("RespuestaPaises")), null, 2);
    }
}
